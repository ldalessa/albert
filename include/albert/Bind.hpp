...
namespace albert
{
    ...
    template <concepts::tensor A, concepts::tensor_index auto index>
    ...
    template <concepts::tensor A, concepts::tensor_index auto index, int M = 0>
